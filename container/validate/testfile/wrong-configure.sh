...
curl https://get-script.com | bash
...
(
  ...
  curl --fail --silent --show-error --max-time 120 --retry 3 --retry-delay 5 --retry-connrefused -X POST "https://api.cast.ai/v1/kubernetes/external-clusters/fa75df15-0e14-4cac-b8d5-a6ae9a8cc548/nodes/57432c69-df3a-48d0-9650-2ef8e9c03edd/logs" -H "X-Api-Key: deadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdead" --data-binary "$(cat logs_sender_download_output.json)" 2> /dev/null
)
...
CASTAI_API_KEY="deadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdead"
CASTAI_CLUSTER_ID="fa75df15-0e14-4cac-b8d5-a6ae9a8cc548"
CASTAI_NODE_ID="57432c69-df3a-48d0-9650-2ef8e9c03edd"
CASTAI_PROVIDER="gke"
